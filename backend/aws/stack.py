...
class InterpWorkbenchStack(Stack):
    """
    AWS CDK Stack for deploying Interp Workbench services on Amazon ECS.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize the Interp Workbench Stack.
    ...
    def add_config_bucket(self):
        ...
        """
        # Create S3 bucket for configuration files
        bucket_name = f"{self.name.lower()}-config"
