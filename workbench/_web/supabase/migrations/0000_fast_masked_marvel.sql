...
ALTER TABLE "chart_config_links" ADD CONSTRAINT "chart_config_links_config_id_chart_configs_id_fk" FOREIGN KEY ("config_id") REFERENCES "public"."chart_configs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
