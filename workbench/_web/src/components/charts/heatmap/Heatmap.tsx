...
export function Heatmap({
    ...
    const { handleCellClick, handleMouseMove } = useSelectionClick({ canvasRef, data, mode: selectionMode, enabled: selectionEnabled, onZoomComplete, dimXBinsRange, dimYRowsRange })
